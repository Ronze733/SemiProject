...
<body>
	<nav
		...
		id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">SKTC<span>South
					Travel Controller</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="ReviewPageC?p=1"
		...
		<div class="container">
			<div
				...
				<div class="col-md-7 ftco-animate">
					...
					<p class="caps">Travel to the any corner of the world, without
